...
static QString dialogContent = "<p>A new version of the Background Removal plugin (<a "
	...
	: QDialog(parent), layout(new QVBoxLayout)
{
	...
	setLayout(layout);
	QLabel *label = new QLabel(dialogContent.replace(QString("{version}"), QString(latestVersion)));
	...
	connect(disableCheckbox, &QCheckBox::stateChanged, this, &UpdateDialog::disableUpdateChecks);
