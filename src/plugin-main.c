...
bool obs_module_load(void)
{
	...
	obs_log(LOG_INFO, "plugin loaded successfully (version %s)",
		...
		if(curl) {
			struct string s;
			init_string(&s);
			curl_easy_setopt(curl, CURLOPT_URL, "https://api.github.com/repos/royshil/obs-backgroundremoval/releases/latest");
			curl_easy_setopt(curl, CURLOPT_USERAGENT, "obs-backgroundremoval");
